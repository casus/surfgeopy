...
class TestSurfgeopyFunctions:
    ...
    def test_pullback(self):
        ...
        # Add an assertion to check if the result matches the expected outcome without any tolerance
    ...
    def test_subdivide(self):
        ...
        # Expected result
        expected_vertices = np.array([[1., 0., 0.],
                                      [0., 1., 0.],
                                      [0., 0., 1.],
                                      [0.5, 0.5, 0.],
                                      [0.5, 0., 0.5],
    ...
    def test_integration_gauss_legendre(self):
        # Define the test case for integration using Gauss-Legendre quadrature
        zero_levelset_function = lambda x: x[0]**2 + x[1]**2 + x[2]**2 - 1
        gradient_function = lambda x: np.array([2*x[0], 2*x[1], 2*x[2]])
        mesh_path = "mesh_test/sphere_N=104.mat"
